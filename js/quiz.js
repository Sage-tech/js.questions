...
*/
const answer1 = prompt("Name a programming lanuage that's also a gem.");
if(answer1.toUpperCase() === 'RUBY'){
correct += 1;
}
  const answer2 = prompt("Name a programming lanuage that's also a snake.");
...
const answer4 = prompt("What language do you sue to build the structure of webpages?");
